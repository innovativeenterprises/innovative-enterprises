...
| **Lexi**   | AI Legal Agent               | A specialist AI that analyzes legal documents for potential risks and liabilities. Lexi is trained on a knowledge base of Omani and international commercial law. She provides structured, preliminary analysis to help users make more informed decisions before consulting a human lawyer. |
...
| **Hira**   | Product Manager (GENIUS)     | Powers the GENIUS Career Platform. Hira analyzes user-uploaded CVs for ATS-compatibility, rewrites resumes to be more impactful, and generates tailored cover letters. |
...
| **Rami**   | Strategy & Research Agent    | Our AI market researcher. Rami performs web research on specific topics, analyzes competitor websites, and tracks industry trends to provide data that informs our overall business strategy. |
