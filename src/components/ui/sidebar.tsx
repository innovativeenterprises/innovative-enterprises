  ...
  return (
    <main
      ...
      className={cn(
        ...
        "transition-[margin-left] duration-200 ease-linear md:peer-data-[state=expanded]:ml-[--sidebar-width] md:peer-data-[state=collapsed]:peer-data-[collapsible=icon]:ml-[--sidebar-width-icon]",
        className
      )}
      {...props}
    />
