...
export const useServicesData = () => {
    ...
    return {
        services,
        setServices: (updater: (prev: Service[]) => Service[]) => {
...
export const useProductsData = () => {
    ...
    return {
        products,
        setProducts: (updater: (prev: Product[]) => Product[]) => {
...
export const useClientsData = () => {
    ...
    return {
        ...
        setTestimonials: (updater: (prev: Testimonial[]) => Testimonial[]) => {
...
export const useProvidersData = () => {
    ...
    return {
        providers,
        setProviders: (updater: (prev: Provider[]) => Provider[]) => {
...
export const useStaffData = () => {
    ...
    return {
        ...data,
        setLeadership: (updater: (prev: Agent[]) => Agent[]) => {
            store.set(state => ({ ...state, leadership: updater(state.leadership) }));
        },
        setStaff: (updater: (prev: Agent[]) => Agent[]) => {
            store.set(state => ({ ...state, staff: updater(state.staff) }));
        },
        setAgentCategories: (updater: (prev: AgentCategory[]) => AgentCategory[]) => {
...
export const useCommunitiesData = () => {
    ...
    return {
        communities,
        setCommunities: (updater: (prev: Community[]) => Community[]) => {
...
export const useCommunityHubData = () => {
    ...
    return {
        ...data,
        setEvents: (updater: (prev: CommunityEvent[]) => CommunityEvent[]) => {
            store.set(state => ({ ...state, communityEvents: updater(state.communityEvents) }));
        },
        setFinances: (updater: (prev: CommunityFinance[]) => CommunityFinance[]) => {
...
export const useMembersData = () => {
    ...
    return {
        members,
        setMembers: (updater: (prev: CommunityMember[]) => CommunityMember[]) => {
...
export const useProjectStagesData = () => {
    ...
    return {
        stages,
        setStages: (updater: (prev: ProjectStage[]) => ProjectStage[]) => {
...
export const useSettingsData = () => {
    ...
    return {
        settings,
        setSettings: (updater: (prev: AppSettings) => AppSettings) => {
...
export const useAssetsData = () => {
    ...
    return {
        assets,
        setAssets: (updater: (prev: Asset[]) => Asset[]) => {
...
export const useInvestorsData = () => {
    ...
    return {
        investors,
        setInvestors: (updater: (prev: Investor[]) => Investor[]) => {
...
export const useKnowledgeData = () => {
    ...
    return {
        knowledgeBase,
        setKnowledgeBase: (updater: (prev: KnowledgeDocument[]) => KnowledgeDocument[]) => {
...
export const useAgenciesData = () => {
    ...
    return {
        agencies,
        setAgencies: (updater: (prev: Agency[]) => Agency[]) => {
...
export const useWorkersData = () => {
    ...
    return {
        workers,
        setWorkers: (updater: (prev: RaahaWorker[]) => RaahaWorker[]) => {
...
export const useRequestsData = () => {
    ...
    return {
        requests,
        setRequests: (updater: (prev: HireRequest[]) => HireRequest[]) => {
...
export const useLeasesData = () => {
    ...
    return {
        leases,
        setLeases: (updater: (prev: SignedLease[]) => SignedLease[]) => {
...
export const useStairspaceData = () => {
    ...
    return {
        stairspaceListings,
        setStairspaceListings: (updater: (prev: StairspaceListing[]) => StairspaceListing[]) => {
...
export const useStairspaceRequestsData = () => {
    ...
    return {
        stairspaceRequests,
        setStairspaceRequests: (updater: (prev: StairspaceRequest[]) => StairspaceRequest[]) => {
...
export const useOpportunitiesData = () => {
    ...
    return {
        opportunities,
        setOpportunities: (updater: (prev: Opportunity[]) => Opportunity[]) => {
...
export const useCostSettingsData = () => {
    ...
    return {
        costSettings,
        setCostSettings: (updater: (prev: CostRate[]) => CostRate[]) => {
...
export const usePricingData = () => {
    ...
    return {
        pricing,
        setPricing: (updater: (prev: Pricing[]) => Pricing[]) => {
...
export const useCfoData = () => {
    ...
    return {
        ...data,
        setKpiData: (updater: (prev: KpiData[]) => KpiData[]) => store.set(s => ({...s, kpiData: updater(s.kpiData)})),
        setTransactionData: (updater: (prev: TransactionData[]) => TransactionData[]) => store.set(s => ({...s, transactionData: updater(s.transactionData)})),
        setUpcomingPayments: (updater: (prev: UpcomingPayment[]) => UpcomingPayment[]) => store.set(s => ({...s, upcomingPayments: updater(s.upcomingPayments)})),
        setVatPayment: (updater: (prev: VatPayment) => VatPayment) => store.set(s => ({...s, vatPayment: updater(s.vatPayment)})),
        setCashFlowData: (updater: (prev: CashFlowData[]) => CashFlowData[]) => store.set(s => ({...s, cashFlowData: updater(s.cashFlowData)})),
        isClient: true,
    };
};
