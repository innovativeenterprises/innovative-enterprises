...
import { Download, Loader2, Mail, Phone, Globe, MapPin, Building2, CheckSquare } from "lucide-react";
    ...
    return (
        <>
            <div style={{ position: 'fixed', left: '-200vw', top: 0, zIndex: -100, opacity: 0 }}>
                <div ref={profileRef} className="bg-white text-gray-900" style={{ width: '210mm', minHeight: '297mm', fontFamily: 'Inter, sans-serif' }}>
                    <div className="p-12">
