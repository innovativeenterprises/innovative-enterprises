...
import { type GenerateSocialMediaPostOutput, type GeneratedPost, GenerateSocialMediaPostInputSchema } from '@/ai/flows/social-media-post-generator.schema';
...
export default function SocialMediaManagementPage() {
  ...
  const watchOutputs = form.watch('platforms');
