        ...
        <SidebarHeader>
          <Button asChild variant="ghost" className="h-auto w-auto p-1">
            <Link href="/" className="flex items-center gap-2">
               <Image src="https://placehold.co/400x100/293462/F0F4F8?text=INNOVATIVE%0AENTERPRISES&font=inter" alt="Innovative Enterprises Logo" width={160} height={40} className="w-32 h-auto object-contain group-data-[collapsible=icon]:hidden" />
