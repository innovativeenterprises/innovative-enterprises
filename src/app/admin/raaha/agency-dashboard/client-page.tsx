...
export default function AdminRaahaClientPage({ initialAgencies, initialWorkers, initialRequests }: AgencyDashboardClientPageProps) {
         ...
         <div className="bg-background min-h-[calc(100vh-8rem)]">
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-7xl mx-auto space-y-8">
                     <div>
                        <h1 className="text-3xl font-bold">RAAHA Agency Management</h1>
                        <p className="text-muted-foreground">Manage all registered workforce agencies, their staff, and client requests.</p>
                    </div>
