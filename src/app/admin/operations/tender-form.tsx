...
import { Loader2, Sparkles, FileText, Download, Copy, Bot } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      {response && (
        <Card className="mt-8">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Bot className="h-6 w-6"/> AI-Generated Draft Response</CardTitle>
