...
import { GraduationCap, ArrowRight, ShieldCheck, Cpu, GanttChartSquare, ClipboardCheck, BarChart, Users, DollarSign, HardHat } from "lucide-react";
...
export default function ConstructionTechAdminPage({ initialProducts }: { initialProducts: Product[] }) {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold">Construction Technology</h1>
                <p className="text-muted-foreground">Manage and monitor all construction-focused platforms and tools.</p>
            </div>
