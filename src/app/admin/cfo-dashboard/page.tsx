...
export default function CfoDashboardPage() {
  ...
  const { kpiData: kpiDataContent, transactionData: transactionDataContent, upcomingPayments: upcomingPaymentsContent, vatPayment: vatPaymentContent, cashFlowData: cashFlowDataContent, investors } = cfoData;
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {transactionDataContent.slice(0, 10).map((transaction, index) => (
                  <TableRow key={index}>
        ...
        <div className="lg:col-span-2 space-y-8">
            <Card>
                ...
                <CardContent>
                    <ChartContainer config={chartConfig} className="h-[200px] w-full">
                        <BarChart data={cashFlowDataContent} accessibilityLayer>
            ...
            <Card className="border-destructive/50 bg-destructive/5">
                ...
                <CardContent className="text-center">
                    <p className="text-4xl font-bold text-destructive">OMR {vatPaymentContent.amount.toFixed(2)}</p>
                    <DueDateDisplay date={vatPaymentContent.dueDate} />
                </CardContent>
            </Card>
             ...
             <Card>
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                           {upcomingPaymentsContent.slice(0, 5).map((payment, index) => (
                               <TableRow key={index}>
                                   <TableCell>
