...
const AddEditListingDialog = ({ 
    ...
    onSave: (values: ListingValues & {description: string}, id?: string) => void,
...
export default function StairspaceTable() {
    ...
    const handleSave = (values: ListingValues & {description: string}, id?: string) => {
                                    ...
                                    <TableCell className="text-right">
                                        <div className="flex justify-end gap-2">
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader><AlertDialogTitle>Delete Listing?</AlertDialogTitle><AlertDialogDescription>This will permanently delete "{listing.title}".</AlertDialogDescription></AlertDialogHeader>
