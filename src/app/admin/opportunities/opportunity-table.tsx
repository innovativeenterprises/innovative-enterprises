...
const AddEditOpportunityDialog = ({ 
    ...
    useEffect(() => { 
        if(isOpen) form.reset(opportunity || { title: "", type: "", prize: "", deadline: "", description: "", status: "Open" }); 
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="sm:max-w-[625px]">
                <DialogHeader>
                    ...
                    <DialogDescription>{opportunity ? "Update the details for this opportunity." : "Enter the details for the new opportunity."}</DialogDescription>
                </DialogHeader>
                <Form {...form}>
