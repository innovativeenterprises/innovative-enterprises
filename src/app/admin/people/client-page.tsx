...
export default function PeoplePageClient({ initialStaffData }: { initialStaffData: { leadership: Agent[], staff: Agent[], agentCategories: AgentCategory[] } }) {
    const { 
    ...
    useEffect(() => {
        setLeadership(() => initialStaffData.leadership);
        setStaff(() => initialStaffData.staff);
        setAgentCategories(() => initialStaffData.agentCategories);
    }, [initialStaffData, setLeadership, setStaff, setAgentCategories]);
