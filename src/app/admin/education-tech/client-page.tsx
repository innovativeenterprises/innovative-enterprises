...
import { GraduationCap, ArrowRight, ShieldCheck, Cpu, GanttChartSquare, ClipboardCheck, BarChart, Users, DollarSign } from "lucide-react";
...
export default function EducationTechClientPage({ products }: { products: Product[]}) {
  return (
