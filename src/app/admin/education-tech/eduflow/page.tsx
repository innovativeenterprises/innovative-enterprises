            ...
            <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Card className="flex flex-col">
                 ...
                 <Card className="flex flex-col">
                    ...
                    <CardFooter className="mt-auto">
                        <Button asChild className="w-full">
                            <Link href="/admin/education-tech/student-financials" legacyBehavior>
                ...
                <Card className="flex flex-col">
                    ...
                    <CardFooter className="mt-auto">
                        <Button asChild className="w-full">
                            <Link href="/admin/education-tech/student-records" legacyBehavior>
                 ...
                 <Card className="flex flex-col">
                    ...
                    <CardFooter className="mt-auto">
                        <Button asChild className="w-full">
                            <Link href="/admin/education-tech/student-housing" legacyBehavior>
