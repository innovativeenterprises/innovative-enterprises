        ...
        >
            ...
            <CardFooter>
                <Button asChild className="w-full">
                    <Link href={`/provider/${provider.id}`} legacyBehavior>View Profile <ArrowRight className="ml-2 h-4 w-4"/></Link>
                </Button>
            </CardFooter>
        </Card>
    );};
                ...
                <Card className="bg-accent/10 border-accent">
                    ...
                    <CardFooter className="justify-start">
                         <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground">
                            <Link href="/partner" legacyBehavior>Register Your Business <ArrowRight className="ml-2 w-4 h-4"/></Link>
                        </Button>
                    </CardFooter>
                </Card>
                 <Card className="bg-muted/50">
                    ...
                    <CardFooter className="justify-start">
                        <Button asChild variant="secondary">
                            <Link href="/submit-work" legacyBehavior>Post a Job Opportunity <ArrowRight className="ml-2 w-4 h-4"/></Link>
                        </Button>
                    </CardFooter>
                </Card>
            </div>
