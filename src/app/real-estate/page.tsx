    ...
    <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
            <Card>
                ...
                <CardFooter>
                    <Button asChild>
                        <Link href="/real-estate/stairspace">Manage Booking Requests <ArrowRight className="ml-2 h-4 w-4" /></Link>
                    </Button>
                </CardFooter>
            </Card>
            <Card>
                ...
                <CardFooter>
                    <Button asChild>
                        <Link href="/real-estate/property-valuator">Launch Valuator <BarChart className="ml-2 h-4 w-4" /></Link>
                    </Button>
                </CardFooter>
            </Card>
        </div>
