...
import { useEventsData, useCommunityFinancesData, useCommunitiesData } from '@/hooks/use-global-store-data';
                    ...
                    <label htmlFor="community-select" className="font-medium text-sm">Viewing Dashboard For:</label>
                     <Select value={selectedCommunityId} onValueChange={setSelectedCommunityId}>
                        <SelectTrigger className="w-[280px]" id="community-select">
                            <SelectValue>{communities.find(c => c.id === selectedCommunityId)?.name}</SelectValue>
                        </SelectTrigger>
                        <SelectContent>
