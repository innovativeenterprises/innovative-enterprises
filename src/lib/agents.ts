...
import { Briefcase, DollarSign, Users, Scale, Headset, TrendingUp, Megaphone, Contact, Cpu, Database, BrainCircuit, Bot, PenSquare, Palette, Languages, Camera, Target, Rocket, Handshake, User, Trophy, WalletCards, NotebookText, MessageCircle, ServerCog, FileText, Building } from "lucide-react";
...
export const initialAgentCategories: AgentCategory[] = [
    ...
    },
    {
        ...
        agents: [
            ...
            { name: "Hubert", role: "Product Manager (Business Hub)", description: "Assists users in navigating the Business Hub, finding partners, and connecting with services.", icon: Building, enabled: true, type: 'AI Agent', photo: 'https://images.unsplash.com/photo-1593941707882-6e87a2b9a5c0?q=80&w=1920&auto=format&fit=crop', aiHint: 'business robot', href: "/business-hub" },
            { name: "Saif", role: "Product Manager (Sanad Hub)", description: "Your AI guide for the Sanad Hub, helping you find services and understand document requirements.", icon: SanadHubIcon, enabled: true, type: 'AI Agent', photo: 'https://images.unsplash.com/photo-1601887383681-4965b39e5573?q=80&w=1920&auto=format&fit=crop', aiHint: 'government assistant robot', href: "/sanad-hub" },
        ]
    },
    {
