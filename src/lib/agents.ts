...
export const initialAgentCategories: AgentCategory[] = [
    {
        ...
        agents: [
            ...
            { name: "Lexi", role: "Contract Risk Analyst", description: "Analyzes legal contracts to identify potential risks, liabilities, and ambiguities before you sign.", icon: Scale, enabled: true, type: 'AI Agent', photo: 'https://images.unsplash.com/photo-1611162617353-c0451a7e8e97?q=80&w=1920&auto=format&fit=crop', aiHint: 'lawyer robot', href: "/contract-analyzer" },
