...
export const initialPosProducts: PosProduct[] = [
    ...
    { id: 'pos_5', name: 'Croissant', category: 'Pastries', price: 1.000, imageUrl: 'https://images.unsplash.com/photo-1597333339831-2d3d7fbe515c?q=80&w=400&auto=format&fit=crop' },
];
