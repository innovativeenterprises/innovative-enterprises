...
2.  **Provide Important Notes:** If there are any critical prerequisites, common issues, or important pieces of information the user should know before starting, add them to the 'notes' field. For example, "Ensure the CR is active and has no violations before proceeding." or "The applicant must be physically present in Oman." If there are no special notes, leave this field blank.
