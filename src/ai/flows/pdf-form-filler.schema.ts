...
export const FilledFormDataSchema = z.object({
    ...
    x: z.number().describe("The x-coordinate (in PDF points/pixels) where the text should start."),
    y: z.number().describe("The y-coordinate (in PDF points/pixels) where the text should start."),
