...
export const IctProposalInputSchema = z.object({
  ...
  numberOfUsers: z.coerce.number().optional().describe("The number of people who will need equipment (attendees, staff, etc.)."),
  projectDurationMonths: z.coerce.number().optional().describe("The duration of the project in months."),
...
const SoftwareSchema = z.object({
  name: z.string().describe("The name of the software (e.g., 'Windows 11 Pro', 'Microsoft 365 Business')."),
  purpose: z.string().describe("The purpose of this software in the project."),
