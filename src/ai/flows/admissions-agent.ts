...
const prompt = ai.definePrompt({
  ...
  input: { schema: AdmissionsAgentInputSchema },
...
**Your Task:**
1.  **Generate Application ID:** Create a unique ID for this application, format: 'APP-[8-digit-number]'.
...
6.  **Recommend Next Step:** Based on your analysis, recommend a next step from the available options: 'Interview', 'Conditional Offer', 'Further Review', or 'Reject'.
